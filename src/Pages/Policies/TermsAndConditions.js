...
import Header from "../../Components/Header";
 ...
 export default function TermsAndConditions(props) {
  return (
    ...
    <p>If you disagree with any of the Terms and Conditions, please immediately terminate your use of the Platform, do
        not click "I Accept" or "I Agree" or download, install or use the App.</p>
    <p><b>1. DEFINITIONS</b></p>
    <p>1.1. "Customer(s)" or "You" or "User" or "End-Users" shall mean any person who accesses, downloads, uses or views
        the Platform and the Services (as defined below).</p>
    <p>1.2. "Intellectual Property Rights" means any and all patents, copyrights, trade secret rights, trademark rights,
    ...
    <p>1.3. "Loan" shall mean the loan that you may apply for through the Platform and which is sanctioned and granted
        by Lender, subject to the applicable terms and conditions of the loan agreement.</p>
    <p>1.4. "Loan Agreement" shall mean the loan agreement to be executed between Lender and the borrower/you for
        granting the Loan.</p>
    <p>1.5. "Online Stores" shall mean Windows Store, Android Google Play, iOS App store or any other online store or
        portal where the App will be made available by the Company to the End-Users, from time to time.</p>
    <p>1.6. "Outstanding Amount(s)" shall mean the principal amount of Loan, interest and applicable charges in
        accordance with the terms of the Loan Agreement due and payable by borrower/you to Lender, on respective due
        date(s).</p>
    <p>1.7. "Personal Information" means information that relates to a natural person, which, either directly or
    ...
    <p>1.8. "Services" means any services or loan facilities requested, made available or received via the Platform.</p>
    <p>1.9. "Third Party Platforms" shall mean social networking platforms, such as Facebook, LinkedIn or other similar
        platforms.</p>
    <p>1.10. "User Data" shall mean any data, information, documents or materials provided by you to the Company prior
        to or during the use of the Services.</p>
    <p><b>2. SERVICES</b></p>
    <p>2.1. You may have to register on the Platform before accessing the complete dashboard made available to You for
    ...
    <p>2.2. The registration on the website does not, in any event, empower You to use the Services unless You have
        ...
        Loan Agreement.</p>
    <p>2.3. The details that You have utilized for the creation of the login ID and password are privy to You or Your
    ...
    <p>2.4. The login ID and passwords are key to the dashboard and acceptance of Services. The access granted to a
        ...
        organization.</p>
    <p>2.5. You authorize the Company to collect and store the Personal Information through the Platform. In order to
    ...
    <p>2.6. You agree that the Personal Information shall always be accurate, correct and complete. As part of the
    ...
    <p>2.7. All transactions undertaken on your behalf by the Company will be on the basis of your express
        ...
        to time.</p>
    <p>2.8. Once you verify and upload the Personal Information and/or other documents and details in the Platform, the
    ...
    <p>2.9. You shall be notified in the event the Company/Lending Partner require any further Know Your Customer
        ("KYC") documents/information from you. Accordingly, the Company/Lending Partner shall verify your KYC in their
        sole discretion.</p>

    <p>2.10. Where a Lending Partner approves your Loan application, you shall be presented with the Loan Agreement on
    ...
    <p>2.11. You understand and acknowledge that certain fees and charges as specified elsewhere on the Platform would
        be payable by you to the Company for processing your Loan application and/or availing any other Services.</p>
    <p>2.12. Upon successful execution of the Loan Agreement and/or other documents, the Loan shall be disbursed as per
    ...
    <p>2.13. Any additional or duplicate payment, if any, made or caused by you will be refunded or cancelled, as the
        case may be, and would be credited to your account as per the Loan Agreement.</p>
    <p>2.14. You understand and acknowledge that the Company reserves the right to retain your Personal Information and
    ...
    <p>2.15. You understand and acknowledge that you shall be solely responsible for all the activities that occur under
    ...
    <p>2.16. You understand and acknowledge that, you are solely responsible for the capability of the electronic
    ...
    <p>2.17. The User Data provided during the registration is stored by the Company for your convenience. You are not
    ...
    <p>2.18. You may delete your User Account by submitting a request to us at support@creditmitra.in subject to there
        being no outstanding payment obligations of you towards the Lending Partners.</p>
    <p><b>3. ELIGIBILITY</b></p>
    <p>3.1. The use of the Platform is available only to persons who can enter into legally binding contracts under
    ...
    <p>3.2. In addition to these general requirements, you may also have to fulfil additional criteria to be able to use
        the Services available on the Platform.</p>
    <p>3.3. If you violate any of the Terms and Conditions, the Company may terminate your membership, close, limit or
        ...
        law.</p>
    <p>3.4. You acknowledge and agree that through the Platform, Company provides you with access to various Services
        ...
        Partners.</p>
    <p>3.5. You agree that Company is in no way responsible for the accuracy, timeliness or completeness of information
    ...
    <p><b>4. MODIFICATIONS AND UPDATES TO THE PLATFORM</b></p>
    <p>4.1. Company is committed to ensuring that the Platform is as useful and efficient as possible. For this reason,
    ...
    <p>4.2. However, the Company will, at least once in a year, inform You of any change in these Terms and Conditions,
        Privacy and Security Policy.</p>
    <p>4.3. The Company will make all reasonable efforts to provide uninterrupted Services subject to downtime and
    ...
    <p>4.4. However, notwithstanding anything in these Terms and Conditions, the User acknowledges that the Platform,
    ...
    <p><b>5. USER'S OBLIGATIONS FOR ACCESSING THE PLATFORM</b></p>
    <p>5.1. You may only use the Platform to avail the Services that may be offered on the Platform by Company and the
    ...
    <p>5.2. You must be the sole owner and User of your User Account. You cannot have more than one User Account at any
    ...
    <p>5.3. The User must notify the Company at support@creditmitra.in as soon as reasonably possible upon becoming
    ...
    <p>5.4. You agree, undertake and confirm not to host, display, upload, modify, publish, transmit, update or share
        any information that:</p>
    <p>a) belongs to another person and to which you do not have any right to;</p>
    <p>b) is grossly harmful, harassing, blasphemous, defamatory, obscene, pornographic, paedophilic, libellous,
    ...
    <p>f) deceives or misleads the addressee about the origin of such messages or communicates any information which is
        grossly offensive or menacing in nature;</p>
    <p>g) impersonate another person;</p>
    <p>h) contains software viruses or any other computer code, files or programs designed to interrupt, destroy or
        limit the functionality of any computer resource; or</p>
    <p>i) threatens the unity, integrity, defence, security or sovereignty of India, friendly relations with foreign
    ...
    <p>5.5. You further agree, undertake and confirm not to:</p>
    <p>a) use the Platform or the Services for committing fraud, embezzlement, money laundering, or for any unlawful
        and/or illegal purposes;</p>
    <p>b) to reproduce, duplicate, copy, sell, resell or exploit any portion of the Platform;</p>
    <p>c) use the Platform to harm or injure any third party;</p>
    <p>d) forge headers or otherwise manipulate identifiers in order to disguise the origin of any content transmitted
        through the Platform;</p>
    <p>e) upload, post, email, transmit or otherwise make available any content that you do not have a right to make
        ...
        agreements);</p>
    <p>f) upload, post, email, transmit or otherwise make available on the Platform, any unsolicited or unauthorized
        advertising, promotional materials, "junk mail," "spam", "chain letters," "pyramid schemes," or any other form
        of solicitation; or</p>
    <p>g) interfere with or disrupt the Platform or servers or networks connected to the Platform, or disobey any
        requirements, procedures, policies or regulations of networks connected to the Platform.</p>

    <p>5.6. We reserve the right, but have no obligation, to monitor the materials posted on the Platform.
    ...
    <p><b>6. CONTENT AVAILABLE</b></p>

    <p>6.1. You acknowledge that the Company makes no representations or warranties about the material, data, and
    ...
    <p>7.1. You understand, acknowledge and agree that the Company is the sole owner of all rights, title and interest,
    ...
    <p>7.2. There may be proprietary logos, service marks and trademarks found on the Platform whether owned/used by the
    ...
    <p>7.3. Company grants you a limited license to access and use the Platform for personal, non-commercial use. This
    ...
    <p>7.4. You understand and acknowledge that the Platform is owned by the Company. Nothing under the Terms and
    ...
    <p>7.5. No Party may, under any circumstances, use or seek to register any trademark, business name, business
        processes, inventions, company name, or domain name using or incorporating the intellectual property of the
        other Party.</p>

    <p>7.6. Each Party acknowledges that upon expiry or termination of the Loan Agreement, it shall have no right
        whatsoever in connection with the Intellectual Property Rights of the other Party.</p>

    <p>7.7. It is agreed between the Parties that during the term any promotion or publicity of the Service would always
        carry 'Company' service marks or the appropriate Company marks as may be agreed between the Parties.</p>

    <p><b>8. THIRD PARTY LINKS IN THE PLATFORM</b></p>

    <p>8.1. The Platform may contain links to other websites owned and operated by third parties who are not related to
    ...
    <p>8.2. The Platform provides these links to you as a convenience only and the inclusion of any link does not imply
    ...
    <p>8.3. The Platform may also contain third party advertisements. The display of such advertisements does not in any
    ...
    <p><b>9. ANCILLARY SERVICES</b></p>

    <p>9.1. While accessing the Platform, You may get access to chat rooms, blogs, feedbacks, reviews and other features
    ...
    <p>9.2. You shall not (nor cause any third party to) use these Ancillary Services to perform any illegal activities
    ...
    <p>9.3. Additionally, the Platform may contain advice/opinions and statements of various professionals/ experts/
    ...
    <p>9.4. All information or details provided on the Platform shall not be interpreted or relied upon as legal,
    ...
    <p>9.5. Nothing contained herein is to be construed as a recommendation to use any product, process or service, and
    ...
    <p><b>10. SUSPENSION/TERMINATION OF SERVICES</b></p>

    <p>10.1. The Company reserves its rights to terminate or suspend your User Account in the event:</p>
    <p>a) you breach any provision of the Terms and Conditions and the Privacy and Security Policy;</p>
    <p>b) the Company is required to do so under applicable law;</p>
    <p>c) the Company chooses to discontinue the Services being offered or discontinue to operate the Platform;</p>
    <p>d) the license granted to use the Platform expires; or</p>
    <p>e) of non-payment of Outstanding Amount(s) by you to the Lender.</p>

    <p>10.2. The Company reserves its right to track you, even when you have uninstalled the App, until all your
        obligations, including but not limited to payment of the Outstanding Amount(s) is in subsistence.</p>

    <p>10.3. Company may wish to stop providing Services through the Platform, and may terminate your use of it at any
    ...
    <p><b>11. DISCLAIMER OF WARRANTIES</b></p>

    <p>11.1. Company operates the Platform as an intermediary and it hereby expressly disclaims all liability,
    ...
    <p>11.2. You agree that Your use of the Platform is being conducted voluntarily and after due research about the
    ...
    <p>11.3. You expressly understand and agree that:</p>
    <p>a) The Platform, all Content and Services included on or otherwise made available to you through the Platform are
    ...
    <p>b) Your use of the Services and the Platform is at your sole risk;</p>
    <p>c) Company shall not be liable for the loss and/or damage of the confidential information or data of the User
    ...
    <p>d) Any material downloaded or otherwise obtained through the access or use of the Platform, is at your own
    ...
    <p>e) The Services are intended for personal, non-commercial use. You shall be solely responsible for the use,
    ...
    <p>f) Company makes no warranty, including implied warranty, and expressly disclaims any obligation, that: (a) the
    ...
    <p>12.1. Notwithstanding anything contained in these Terms and Conditions, You undertake and agree to indemnify and
    ...
    <p>a) your breach of the Terms and Conditions or Privacy and Security Policy;</p>
    <p>b) your breach of any rights of other users of the Platform;</p>
    <p>c) your use or misuse of the Platform or the Services;</p>
    <p>d) your violation of applicable laws.</p>

    <p>12.2. This clause shall survive termination of these Terms and Conditions. However, the claims for indemnity
    ...
    <p>12.3. Notwithstanding anything contained herein, the Company has a right to withhold or set off its claims of
    ...
    <p><b>13. LIMITATIONS OF LIABILITY</b></p>

    <p>13.1. You expressly understand and agree that the Company, including its directors, officers, employees or
    ...
    <p>13.2. In no event shall the Company be liable to any third party(ies). And in no event shall the Company's total
    ...
    <p>14.1. Company shall not be held responsible for damage, loss, non-availability of the Platform or its Services,
    ...
    <p><b>15. PRIVACY POLICY</b></p>

    <p>15.1. Company may collect, store, use, process and transfer to third parties information provided by you at the
    ...
    <p>15.2. You acknowledge and agree that you cannot withdraw your consent to the Privacy and Security Policy during
    ...
    <p><b>16. GOVERNING LAW & JURISDICTION</b></p>

    <p>16.1. The Terms and Conditions (and by extension, the Privacy and Security Policy) are governed by and construed
    ...
    <p>17.1. Each of the provisions of the Terms and Conditions is severable from the others and if one or more of them
        becomes void, illegal or unenforceable, the remainder will not be affected in any way.</p>

    <p>17.2. The rights of the Company, its affiliates, associates and agents under the Terms and Conditions may be
    ...
    <p>17.3. The User may not assign, part with or otherwise transfer any right or benefit under any provision of the
        Terms and Conditions without the Company's prior written consent.</p>

    <p>17.4. Company may assist or cooperate with authorities in any jurisdiction in relation to any direction or
        request to disclose personal or other information regarding any User or the use of the Platform, Content or the
        Services.</p>

    <p>17.5. These Terms and Conditions (including the Privacy and Security Policy) constitute the entire agreement and
    ...
    <p><b>18. GRIEVANCES</b></p>

    <p>18.1. If you have any concerns regarding the Platform, these Terms and Conditions or the Services, please contact
