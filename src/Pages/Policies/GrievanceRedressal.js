    ...
    <>
      ...
      <div className="main" style={{ color: "#fff", padding: "1rem" }}>
        ...
        <p>
          ...
          received from our customers. We make sure that our customers feel
          secure and heard while using the Platform.
        </p>
        <p>
          We aim to resolve any complaint or grievance which may arise as a
          result of any gap in the promised and delivered services. This shall
          also apply to all queries and/or feedback received from our customers.
          We encourage our customers to provide feedback in respect of our
          services and aim to improve the quality of our products and services.
        </p>
        <p>
          The motive of this Policy is to reduce customer grievances through
          appropriate redressal mechanisms. We have put in place a very robust
          and customer-friendly structure to ensure that all your grievances are
          resolved in a timely and effective manner. This structure is approved
        ...
        <ol>
          <li>
            Treating the customer in a fair and respectful manner while
            redressing their grievances and queries.
          </li>
          <li>
            Making the process of grievance redressal for customers efficient
            and hassle-free.
          </li>
          <li>
          ...
          <li>
            Helping customers at all stages of grievance redressal and making
            them aware of their right(s) to approach the higher stage of
            grievance redressal.
          </li>
        </ol>
        ...
        <p>
          E-mail: customers can send an email for redressal of issues at the
          email id(s) as mentioned hereunder in this Policy.
        </p>
        ...
        <p>
          To make the grievance redressal mechanism more meaningful and
          effective, Our management has laid down an escalation mechanism in
          compliance with various applicable regulations. The management will
          periodically review the effectiveness of grievance redressal mechanism
          escalation matrix. We have created the following escalation system for
          our customers:
        </p>
        ...
        <ul>
          <li>
            ...
            <a href="mailto:support@creditmitra.in">support@creditmitra.in</a>{" "}
            for any query regarding our services. Customers shall ensure that
            they quote their Loan ID number in every correspondence with
            CreditMitra regarding their grievances. Any complaint registered has
            to be acknowledged by the Support Team.
          </li>
          <li>
          ...
          <li>
            The aforementioned timelines may change depending upon the nature
        ...
        <ul>
          <li>
            ...
            <a href="mailto:grievance@creditmitra.in">
              grievance@creditmitra.in
            </a>{" "}
            (“GRO”) for any grievance regarding our services or products.
          </li>
          <li>
            Working Hours: Monday-Friday (except public holidays), 9:30 am to
            6:30 pm
          </li>
          <li>
        ...
        <ul>
          ...
          <li>
            We are determined to provide the first response to the customer
