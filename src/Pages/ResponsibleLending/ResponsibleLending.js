                ...
                <div className='page-container responsible-lending-page'>
                    <div className="responsible-lending-section">
                        <div className='content'>
                            ...
                            <p>CreditMitra operates as a platform facilitating loan transactions between borrowers and NBFCs. Approval and sanctioning of all loan applications are carried out by NBFCs registered with RBI, and this information is communicated upfront during the loan application process.</p>
                        </div>
                        <h5 className='section-heading'>Our Pledge as a Responsible Lender</h5>
                        <div className='list-container'>
                            {pledgePoints.map((each, index)=>{
                                return <>
                                <ApplicationProcessingCard orderNo={index+1} description={each}/>
                                </>
                            })}
                        </div>
                    </div>
