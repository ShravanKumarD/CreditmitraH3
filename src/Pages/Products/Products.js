    ...
    return (
        ...
        <section>
            <div className='page-container products-page'>
                ...
                <DescriptionSection heading="Eligibility Criteria" points={["Indian Citizen ", "Age Limit: 21- 55 Years", "Salaried Individual", "Monthly Income: >INR 15,000"]} img={StepsImg}/>
            </div>
            <Footer/>
        </section>
    </>
