...
const PersonalLoanforSalaried = (props) => {
  return (
    <>
      ...
      <section>
        <div className="page-container products-page">
          <div className="products-hero-section ">
            ...
            <small>Get Empower with your Finance Mitra</small>
            <p>
              CreditMitra understands the value of a steady income and the
              aspirations that come with it. Our personal loan for salaried
              Individuals is designed to be your trusted companion on your
              financial journey, offering customised solutions just for you and
              your ambitions
            </p>
          ...
          <DescriptionSection
            ...
            img={StepsImg2}
          />
          <div className="uncolored-heading">
            Personal Loan For Salaried Details
          </div>
...
export default PersonalLoanforSalaried;
