  ...
  return (
    <>
      ...
      <section>
        <div className="page-container products-page">
          ...
          <div className='productHeader'>Instant Personal Loan</div>
            ...
            <p>
              We are a gateway of financial possibilities, Creditmitra's instant
              personal loan is the solution to all your financial problems.
              Here, aspirations meet reality in the blink of an eye! It is time
              to Get Ready to Chart Your Financial Destiny!
            </p>
      ...
      {loading && <Loader />}
          ...
          >
            Don't let your dreams sit on the shelf forever! Hop on with your
            best finance Mitra, Creditmitra today and unlock the door to endless
            possibilities. Let Creditmitra's instant personal loan help you
            target your financial goal!
          </h6>
        </div>
        <Footer />
      </section>
