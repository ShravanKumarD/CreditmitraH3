        ...
        <div className="page-container products-page">
          ...
          <div className="products-hero-section ">
            ...
            <p>
              ...
              help you bridge the gap when you need it most. An emergency loan
              is a flexible personal loan designed to cover a wide range of
              unexpected costs. Whether it's a car repair, appliance
              replacement, urgent home improvement, or any other pressing
              financial need, our emergency loan can provide the quick cash you
          ...
          <DescriptionSection
            ...
            points={[
              "Flexible Repayment: Choose a repayment plan that works for you, with flexible terms to make managing your loan comfortable.",
              "Competitive Rates: We offer competitive interest rates on personal loans for emergencies to minimize the financial burden of your loan.",
              "Fast Approval & Funding: Get a quick decision on your loan application and receive funds within hours to address your emergency. ",
              "Minimal Documents: We require only the essential documents to get your emergency loan approved quickly.",
            ]}
            img={StepsImg}
          />
          <DescriptionSection
            heading="Get Emergency Loan with Ease: A Simple 4-Step Loan Process "
            points={[
              ...
              "Funds in Reach: Get the emergency loan amount deposited directly into your account.",
            ]}
            img={StepsImg2}
          />
          <div className="uncolored-heading">Emergency Loan Details</div>
          ...
          >
            Unexpected situations shouldn't derail your financial goals. With an
            emergency loan from CreditMitra, you can address urgent needs with
            confidence, knowing you have a manageable repayment plan in place.
            Get our emergency loans with a simple application process. We'll
