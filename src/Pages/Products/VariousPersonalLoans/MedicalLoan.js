      ...
      <section>
        <div className="page-container products-page">
          ...
          <div className="products-hero-section ">
            ...
            <small>CreditMitra supports you when you're in need!</small>
            <p>
              At CreditMitra, we understand the financial stress unexpected
              medical emergencies can cause. That's why we offer convenient and
              accessible medical loans to help you manage healthcare costs. A
              medical loan is a type of personal loan designed specifically to
              cover medical expenses. This can include hospital stays, doctor
              visits, surgery costs, prescription medications, and even dental
              procedures. Unlike medical insurance, a medical loan allows you to
              cover a wider range of expenses, providing flexibility during a
              challenging time
            </p>
          ...
          <DescriptionSection
            ...
            img={StepsImg2}
          />
          <div className="uncolored-heading">Medical Loan Details</div>
          ...
          >
            Whether you need to cover an unexpected procedure or ongoing medical
            treatment, our medical loans can provide the financial support you
            need. Get our medical loan with a simple application process. We'll
