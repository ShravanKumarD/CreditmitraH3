  ...
  const feedbacks = [
    {
      ...
      comment:
        "Skilled local customer service representatives from Mumbai are on board to answer any questions you may have and guide you through the loan application process.",
    },
    {
      ...
      <section>
        <div className="page-container products-page">
          <div className="Location-section">
            ...
            <small>Need Cash in Mumbai? Get Approved Within Minutes</small>
            <p>
              Mumbai is a city that never sleeps, and neither should your
              financial options. With CreditMitra, the reliable rapid loan app
              in Mumbai, you may easily and swiftly obtain the money you require
