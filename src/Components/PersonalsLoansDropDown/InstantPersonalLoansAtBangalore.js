  ...
  const feedbacks = [
    {
      ...
      comment: "Skilled local customer service representatives from Bangalore are on board to answer any questions you may have and guide you through the loan application process.",
    },
    {
      ...
      <section>
        <div className="page-container products-page">
          <div className="Location-section">
            <h6 className='header'>Instant Loans in Bangalore</h6>
            <small>
            Need Cash in Bangalore?
Get Approved Within Minutes 
            </small>
            <p>
            Bangalore's fast-paced lifestyle may incur unforeseen costs. Don't let a cash flow gap cause you to miss that weekend getaway to Goa, a flat tire, or an unexpected medical expenditure. The most trusted rapid loan app in Bangalore, CreditMitra, is here to help you easily and swiftly obtain the money you require.
            </p>
            <div className='sub-title'>
              <h2>Why CreditMitra is the top choice in Bangalore?</h2>
            </div>
