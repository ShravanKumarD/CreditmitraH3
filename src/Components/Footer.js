                ...
                <div className='footer-content'>
                    <div className='footer-container row'>
                        <div className='col-sm-4'>
                            ...
                            <p className='pinFooter'>Welcome to CreditMitra, Your Gateway to Financial Empowerment! At CreditMitra, you can Navigate through our user-friendly platform to access a range of credit solutions tailored to your needs.</p>
